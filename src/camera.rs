...
impl Camera {
    pub fn new(aspect_ratio: f64, image_width: i64, camera_center: Point3, samples_per_pixel: i64, max_depth: i64, fov: f64, look_at: Point3, vup: Vec3, focus_dist: f64, defocus_angle: f64) -> Self {
        ...
        let viewport_upper_left = camera_center - frame_basis_w * focus_dist - viewport_u/2.0 - viewport_v/2.0;
        ...
        Camera { aspect_ratio, image_width, image_height, viewport_width, viewport_height, camera_center, viewport_u, viewport_v, pixel_delta_u, pixel_delta_v, viewport_upper_left, pixel00, samples_per_pixel, max_depth, fov, look_at, vup, frame_basis_u, frame_basis_v, frame_basis_w, focus_dist, defocus_angle, defocus_u, defocus_v, defocus_radius }
    }
